...
export default function MapClient({ facilities = [], userLocation, zoom = 12 }) {
            ...
            >
              <Popup>
                <div className="p-1">
                  ...
                  <p className="text-xs text-gray-600 mb-2">{facility.facility_type}</p>
                  
                  {facility.distance_km && (
                    <p className="text-xs mb-2">{facility.distance_km} km away</p>
                  )}
                  
                  <div className="flex flex-col gap-2 mt-2">
                    <Link href={`/facilities/${facility.id}`} className="text-xs text-blue-600 font-medium hover:underline">
                      View Details
                    </Link>
                    <a 
